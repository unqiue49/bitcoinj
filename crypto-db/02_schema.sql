...
create table nets
(
    net_id   smallserial primary key,
    protocol varchar(12),
    code     varchar(12),
    name     varchar(48),
    test     boolean
...
insert into nets(protocol, code, name, test) values ('bitcoin','MAINNET','org.bitcoin.production', false);
insert into nets(protocol, code, name, test) values ('bitcoin','TESTNET','org.bitcoin.test', true);
insert into nets(protocol, code, name, test) values ('bitcoin','SIGNET','org.bitcoin.signet', true);
insert into nets(protocol, code, name, test) values ('bitcoin','REGTEST','org.bitcoin.regtest', true);
...
(
    ...
    hash           bytea NOT null,
    inputs         jsonb NOT null COMPRESSION pglz,
    outputs        jsonb NOT null COMPRESSION pglz,
